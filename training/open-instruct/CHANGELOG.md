...
### Fixed
- Resolve Apptainer-family sandbox image references against an operator-provided local SIF pool, including mirror-reference hash fallback (https://github.com/hamishivi/tmax/pull/8).
