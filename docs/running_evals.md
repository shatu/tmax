...
|---|---|---|
| 0 | `vllm` | Serves the model. Skips podman, compose, the harbor patches, and the Docker Hub login entirely — it never runs a container. |
| 1 | `eval` | Everything else. Runs harbor's containers; never touches a GPU. |
